...
module.exports = makeSchema(
  {
    ...
    properties: {
      ...
      beforeApp: {
        description:
          'Before the perform method is called on your app, you can modify the execution context.',
        $ref: MiddlewaresSchema.id
      },
      afterApp: {
        description:
          'After the perform method is called on your app, you can modify the response.',
        $ref: MiddlewaresSchema.id
      },
      authentication: {
