...
const MigrationsSchema = require('./MigrationsSchema');
...
module.exports = makeSchema(
  {
    ...
    properties: {
      ...
      migrations: {
        description:
          'All the migrations for your app. Each migration has hooks that will run when changing zaps between different versions of your app',
        $ref: MigrationsSchema.id
      }
    },
