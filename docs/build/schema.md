...
`migration` | no | [/MigrationSchema](#migrationschema) | Migration hooks that will run when changing zaps between different versions of your app
...
* **Type** - `object`
* **Pattern** - _n/a_
* **Source Code** - [lib/schemas/MigrationSchema.js](https://github.com/zapier/zapier-platform-schema/blob/v5.0.0/lib/schemas/MigrationSchema.js)
