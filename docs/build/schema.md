...
`migrations` | no | [/MigrationsSchema](#migrationsschema) | All the migrations for your app. Each migration has hooks that will run when changing zaps between different versions of your app
...
Represents migration schemes.

#### Details

* **Type** - `object`
* **Pattern** - _n/a_
* **Source Code** - [lib/schemas/MigrationSchema.js](https://github.com/zapier/zapier-platform-schema/blob/v7.0.0/lib/schemas/MigrationSchema.js)
...
Key | Required | Type | Description
--- | -------- | ---- | -----------
`mapping` | **yes** | `object` | An object describing each of an application's actions and the changes that need to be applied to successfully migrated steps to this version of your app
`pre` | no | [/FunctionSchema](#functionschema) | Function to be run before applying your mapping to a migrating step
`post` | no | [/FunctionSchema](#functionschema) | Function to be run after applying your mapping to a migrating step
`authentication` | no | [/FunctionSchema](#functionschema) | Function to be run when transitioning between authentications - will only run once per account

-----

## /MigrationsSchema

Enumerates the migrations your app has available.

#### Details

* **Type** - `array`[[/MigrationSchema](#migrationschema)]
* **Pattern** - _n/a_
* **Source Code** - [lib/schemas/MigrationsSchema.js](https://github.com/zapier/zapier-platform-schema/blob/v7.0.0/lib/schemas/MigrationsSchema.js)
