...
`legacyScriptingSource` | no | [/CodeSchema](#codeschema) | **INTERNAL USE**. Zapier uses this to store the scripting code from a legacy Web Builder app.
...
`legacyProperties` | no | [/FlatObjectSchema](#flatobjectschema) | **INTERNAL USE ONLY**. Zapier uses this to store properties from a legacy Web Builder app.
...
Free-form source code without validation.

#### Details

* **Type** - `string`
* **Pattern** - _n/a_
* **Source Code** - [lib/schemas/CodeSchema.js](https://github.com/zapier/zapier-platform-schema/blob/v6.0.0/lib/schemas/CodeSchema.js)
