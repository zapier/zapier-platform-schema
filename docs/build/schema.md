...
* [/ResourceMethodMiscSchema](#resourcemethodmiscschema)
...
* **Type** - `object`
* **Pattern** - _n/a_
* **Source Code** - [lib/schemas/ResourceMethodMiscSchema.js](https://github.com/zapier/zapier-platform-schema/blob/v5.2.0/lib/schemas/ResourceMethodMiscSchema.js)

#### Examples

* ```
  { display: { label: 'Reticulate Tag', description: 'Reticulate a Tag in your account.' },
    operation: { perform: '$func$2$f$', sample: { id: 1 } } }
  ```
* ```
  { display: { label: 'Reticulate Tag', description: 'Reticulate a Tag in your account.', hidden: true },
    operation: { perform: '$func$2$f$' } }
  ```
...
Key | Required | Type | Description
--- | -------- | ---- | -----------
`display` | **yes** | [/BasicDisplaySchema](#basicdisplayschema) | Define how this misc method will be exposed in the UI.
`operation` | **yes** | [/BasicActionOperationSchema](#basicactionoperationschema) | Define how this misc method will work.
  ...
  { key: 'tag',
    ...
    list: 
     { first_tag_extra_nest: 
        { display: { label: 'List Tags', description: 'Grab all the tags.' },
          operation: 
...
`hook` | no | oneOf([/ResourceMethodHookSchema](#resourcemethodhookschema), _n/a_) | How will we get notified of new objects? Will be turned into a trigger automatically.
`list` | no | oneOf([/ResourceMethodListSchema](#resourcemethodlistschema), _n/a_) | How will we get a list of new objects? Will be turned into a trigger automatically.
`search` | no | oneOf([/ResourceMethodSearchSchema](#resourcemethodsearchschema), _n/a_) | How will we find a specific object given filters or search terms? Will be turned into a search automatically.
`create` | no | oneOf([/ResourceMethodCreateSchema](#resourcemethodcreateschema), _n/a_) | How will we find create a specific object given inputs? Will be turned into a create automatically.
`misc` | no | oneOf([/ResourceMethodMiscSchema](#resourcemethodmiscschema), _n/a_) | How will we find perform a miscellaneous action for a specific object given inputs? Will be turned into an action automatically.
